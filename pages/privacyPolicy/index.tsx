...
const privacy = () => (
    ...
    Policy and agree to its terms.<br/><br/>
    ...
    data protection rights. Every user is entitled to the following:<br/>

    The right to access – You have the right to request copies of 
    your personal data. We may charge you a small fee for this service.<br/>
    ...
    to promptly remove such information from our records.<br/><br/>
